...
$PDO->exec("INSERT INTO ".TABLE_PREFIX."layout (id, name, content_type, content, created_on, updated_on, created_by_id, updated_by_id) VALUES (3, 'Simple-new', 'text/html', '<!DOCTYPE html>\r\n<html>\r\n    <head>\r\n        <title><?php echo $this->title();?></title>\r\n        <meta name="description" content="<?php echo ($this->description() != '''') ? $this->description() : ''Default description goes here''; ?>">\r\n        <meta name="keywords" content="<?php echo ($this->keywords() != '''') ? $this->keywords() : ''default, keywords, here''; ?>">\r\n        <meta name="description" content="Author Name">\r\n        <meta name="viewport" content="width=device-width, initial-scale=1">\r\n        <link rel="stylesheet" href="/public/themes/simple-new/style.css">\r\n        <link rel="shortcut icon" href="/public/themes/simple-new/images/favicon.ico">\r\n    </head>\r\n    <body>\r\n        <main>\r\n            <header>\r\n                <h1><a href="/">Wolf blog</a></h1>\r\n                <h2>the blog about wolfs</h2>\r\n            </header>\r\n            <nav>\r\n                <ul>\r\n<?php foreach($this->find(''/'')->children() as $menu): ?>\r\n                    <li><?php echo $menu->link($menu->title, (in_array($menu->slug, explode(''/'', $this->url)))); ?></li>\r\n<?php endforeach; ?> \r\n                </ul>\r\n            </nav>\r\n            <aside>\r\n                <?php echo $this->content(''sidebar'', true); ?>\r\n            </aside>\r\n            <div id="content">\r\n                <h1><?php echo $this->title();?></h1>\r\n                <?php echo $this->content();?>\r\n            </div>\r\n            <footer>\r\n                <a href="http://wolfcms.org">Wolf CMS inside</a><br>\r\n                The header background is an adapted version of <a href="https://commons.wikimedia.org/wiki/File:Scandinavian_grey_wolf_Canis_lupus.jpg">Scandinavian grey wolf Canis lupus</a> by <a href="https://commons.wikimedia.org/wiki/User:Malene">Malene Thyssen</a>, licensed under the <a href="https://creativecommons.org/licenses/by-sa/3.0/deed">Creative Commons Attribution-Share Alike 3.0 Unported</a>\r\n            </footer>\r\n        </main>\r\n    </body>\r\n</html>', '".wolf_datetime_incrementor()."', '".wolf_datetime_incrementor()."', 1, 1)");
