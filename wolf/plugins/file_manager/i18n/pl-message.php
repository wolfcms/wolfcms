<?php
    ...
    return array(
    'A file or directory with that name already exists!' => 'Plik lub katalog z ta nazwa już istnieje!',
    'A possible hack attempt was detected.' => 'Wykryta została możliwość włamania.',
    'Action' => 'Akcja',
