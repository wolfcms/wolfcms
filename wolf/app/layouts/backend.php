...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    ...
    <link rel="favourites icon" href="<?php echo URI_PUBLIC; ?>wolf/<?php echo ADMIN_DIR; ?>/images/favicon.ico" />
    <link href="<?php echo URI_PUBLIC; ?>wolf/<?php echo ADMIN_DIR; ?>/stylesheets/admin.css" media="screen" rel="Stylesheet" type="text/css" />
    <link href="<?php echo URI_PUBLIC; ?>wolf/<?php echo ADMIN_DIR; ?>/themes/<?php echo Setting::get('theme'); ?>/styles.css" id="css_theme" media="screen" rel="Stylesheet" type="text/css" />

    <!-- IE6 PNG support fix -->
    <!--[if lt IE 7]>
        <script type="text/javascript" charset="utf-8" src="<?php echo URI_PUBLIC; ?>wolf/<?php echo ADMIN_DIR; ?>/javascripts/unitpngfix.js"></script>
    <![endif]-->
    <script type="text/javascript" charset="utf-8" src="<?php echo URI_PUBLIC; ?>wolf/<?php echo ADMIN_DIR; ?>/javascripts/cp-datepicker.js"></script>
    <script type="text/javascript" charset="utf-8" src="<?php echo URI_PUBLIC; ?>wolf/<?php echo ADMIN_DIR; ?>/javascripts/wolf.js"></script>
    <script type="text/javascript" charset="utf-8" src="<?php echo URI_PUBLIC; ?>wolf/<?php echo ADMIN_DIR; ?>/javascripts/jquery-1.4.2.min.js"></script>
    <script type="text/javascript" charset="utf-8" src="<?php echo URI_PUBLIC; ?>wolf/<?php echo ADMIN_DIR; ?>/javascripts/jquery-ui-1.8.5.custom.min.js"></script>
    <script type="text/javascript" charset="utf-8" src="<?php echo URI_PUBLIC; ?>wolf/<?php echo ADMIN_DIR; ?>/javascripts/jquery.ui.nestedSortable.js"></script>

    <script type="text/javascript" src="<?php echo URI_PUBLIC; ?>wolf/<?php echo ADMIN_DIR; ?>/markitup/jquery.markitup.js"></script>
    <link rel="stylesheet" type="text/css" href="<?php echo URI_PUBLIC; ?>wolf/<?php echo ADMIN_DIR; ?>/markitup/skins/simple/style.css" />
