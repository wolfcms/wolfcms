...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <link href="<?php echo URI_PUBLIC; ?>admin/stylesheets/newadmin.css" media="screen" rel="Stylesheet" type="text/css" />
        ...
        <link href="<?php echo URI_PUBLIC; ?>admin/stylesheets/jquery-ui-1.7.2.custom.css" media="screen" rel="Stylesheet" type="text/css" />
    ...
    <?php endif; if (file_exists(CORE_ROOT . '/plugins/' . $plugin_id . '/' . $plugin_id . '.css')): ?>
    ...
    <div id="header">
        ...
        <div id="mainTabs">
            ...
            foreach (Plugin::$controllers as $plugin_name => $plugin):
                if ($plugin->show_tab && (AuthUser::hasPermission($plugin->permissions) || AuthUser::hasPermission('administrator'))):
