 ...
 */
?>
<h2><?php echo __(ucfirst($action).' user'); ?></h2>

<div class="panel panel-default">

<form role="form" action="<?php echo $action=='edit' ? get_url('user/edit/'.$user->id): get_url('user/add'); ; ?>" method="post">
    <input id="csrf_token" name="csrf_token" type="hidden" value="<?php echo $csrf_token; ?>" />
  <table class="fieldset" cellpadding="0" cellspacing="0" border="0">
    <tr>

      <td class="label"><label for="user_name"><?php echo __('Name'); ?></label></td>
      <td class="field"><input class="form-control" id="user_name" maxlength="100" name="user[name]" size="100" type="text" value="<?php echo $user->name; ?>" /></td>
      <td class="help"><?php echo __('Required.'); ?></td>
    </tr>
    <tr>
      <td class="label"><label class="optional" for="user_email"><?php echo __('E-mail'); ?></label></td>
      <td class="field"><input class="form-control" id="user_email" maxlength="255" name="user[email]" size="255" type="email" value="<?php echo $user->email; ?>" /></td>
    ...
    <tr>
      ...
      <td class="field"><input class="form-control" id="user_username" maxlength="40" name="user[username]" size="40" type="text" value="<?php echo $user->username; ?>" <?php echo $action == 'edit' ? 'disabled="disabled" ': ''; ?>/></td>
    ...
    <tr>
      ...
      <td class="field"><input class="form-control" id="user_password" maxlength="40" name="user[password]" size="40" type="password" value="" /></td>
...
<?php endif; ?>
    ...
    <tr>
        ...
        <td class="field">
          <select class="select form-control" id="user_language" name="user[language]">
...
<?php Observer::notify('user_edit_view_after_details', $user); ?>
  ...
  <p>
    <input class="btn btn-primary" name="commit" type="submit" accesskey="s" value="<?php echo __('Save'); ?>" />
