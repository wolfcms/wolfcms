    ...
    private function _buildMessage() {
        ...
        switch ($this->_getContentType()) {
            ...
            case 'html-attach' :
                ...
                $h .= "Content-Type: multipart/alternative; boundary=\"" . $this->_alt_boundary . "\"" . $this->newline .$this->newline;
                $h .= "--" . $this->_alt_boundary . $this->newline;
                ...
                if ($this->_getProtocol() == 'mail') {
                    ...
                    $body  = $h.$this->newline.$this->newline.$this->_body . $this->newline . $this->newline;
