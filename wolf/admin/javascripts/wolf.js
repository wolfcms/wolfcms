...
var SiteMap = Class.create(RuledList, {
  ...
  getBranch: function(row)
  {
    ...
    new Ajax.Updater(
      row,
      'index.php?WOLFAJAX=/page/children/' + id + '/' + level,
      {
        evalScripts: true,
        asynchronous: true,
        insertion:  "bottom",
  ...
  update: function()
  {
    ...
    new Ajax.Request('index.php?WOLFAJAX=/page/reorder/'+parent_id, {method: 'post', parameters: { 'data': data }});
  },
  ...
  copy: function(element) 
  {
    ...
    new Ajax.Request('index.php?WOLFAJAX=/page/copy/'+parent_id, {
      method: 'post',
